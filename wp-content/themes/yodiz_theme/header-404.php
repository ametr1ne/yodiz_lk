...
<head>
	...
	<link rel="stylesheet" href="<?= get_template_directory_uri() ?>/assets/scss/404.css"/>
    <script defer src="<?= get_template_directory_uri() ?>/assets/js/jquery.min.js"></script>
    <script defer src="<?= get_template_directory_uri() ?>/assets/js/coursesPage.js"></script>
...
<header class="header">
	...
	<div class="header__wrapper">
		<div class="header__left">
			...
			<a class="header__links" href="<?= home_url() ?>/courses">Мои курсы</a>
		</div>
