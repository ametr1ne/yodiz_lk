...
<main class="main">
	...
	<div class="content">
		<div class="content__wrapper">
			...
			<p class="breadcrumbs text-grey"><a style="color: #0500FF" href="<?= home_url() ?>/courses">Курсы от Yodiz School</a> / <?php the_field( 'course_name', $post->post_parent ); ?> / <?php the_field('lesson_num') ?></p>
			<h1><?php the_field('title_name') ?></h1>

			<?php include 'componets/uxmarafon.php' ?>
...
<div class="popup free-popup marafon-popup">
    ...
    <div class="popup__content">
        <p class="free">Следите за ходом марафона в закрытой группе ВКонтакте — <a class="marafon_link" href="https://vk.com/yodizmarafon" target="_blank">vk.com/yodizmarafon</a> </p>
...
<noscript><div><img src="https://mc.yandex.ru/watch/88205003" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
